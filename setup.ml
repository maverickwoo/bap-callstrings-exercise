...
(* OASIS_START *)
(* DO NOT EDIT (digest: fc2fb746298b0be2841439bde803e9e2) *)
(*
...
let setup_t =
  {
     ...
     build = OCamlbuildPlugin.build ["-j"; "4"; "-tag"; "syntax_camlp4o"];
     test = [];
     doc = [];
     ...
     package =
       {
          ...
          build_custom =
            {
               pre_command = [(OASISExpr.EBool true, None)];
               post_command =
                 [(OASISExpr.EBool true, Some (("sh", ["postbuild.sh"])))]
            };
          ...
          clean_custom =
            {
               pre_command =
                 [(OASISExpr.EBool true, Some (("sh", ["preclean.sh"])))];
               post_command = [(OASISExpr.EBool true, None)]
            };
          distclean_custom =
            {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_byteopt =
                        [(OASISExpr.EBool true, ["-ppopt"; "-lwt-debug"])];
                      bs_nativeopt =
                        [(OASISExpr.EBool true, ["-ppopt"; "-lwt-debug"])]
                   },
                   {
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\020;Ä®,Ïå¿îõv\155_\000Áp";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
